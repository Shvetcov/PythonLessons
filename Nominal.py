...
def calc_offset(image1, image2) -> [int, int] or None:
...
offset = calc_offset(image1, image2)
if offset:
    print(f'Смещение соответствует {offset[0]} by X and {offset[1]} by Y')
else:
    print('Одно из изображений отличается')